...
interface LogisticsZincProps extends WithFormFieldsStateProps {
...
const LogisticsZinc: React.FC<LogisticsZincProps> = ({
                                                         onSave,
                                                         formFieldsState,
                                                         setFormFieldsState,
                                                         activeStep,
    ...
    const [Logistics_Z_Logistics, setLogistics_Z_Logistics] = useState<string>('London Metal Exchange');
    ...
    useMemo(() => {
        ...
        if (formFieldsState.length > 0) {
            ...
            formFieldsState.forEach((fieldState) => {
                    if (fieldState.key === 'Logistics_Z_Logistics') {
                        setLogistics_Z_Logistics(fieldState.value);
                    }
                }
            );
        }
    ...
    const requiredFields = ["Logistics_Z_Logistics"];
    ...
    const handleInputChange = (key: string, value: string) => {
        ...
        if (key === 'setLogistics_Z_Logistics') {
            setLogistics_Z_Logistics(value);
        }
                ...
                <Grid item xs={6} md={6}>
                    ...
                    >
                        ...
                        <TextField
                            ...
                            name="name"
                            autoComplete="off"
                            value={Logistics_Z_Logistics}
                            onChange={(e) => {
                                const value = e.target.value;
                                handleInputChange("Logistics_Z_Logistics", value);
                            }}
                            error={validated && !Logistics_Z_Logistics}
                            helperText={
                                validated &&
                                    (!Logistics_Z_Logistics || parseFloat(Logistics_Z_Logistics) <= 0)
...
export default withFormFieldsState(LogisticsZinc as React.ComponentType<Omit<LogisticsZincProps, 'formFieldsState' | 'setFormFieldsState' | 'subStepId'>>);